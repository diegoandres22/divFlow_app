...
export default function PreloaderII() {
    useGSAP(() => {
        ...
        // Splitting before the real webfont is active measures chars/lines
        // with fallback-font metrics (DevTools warns "SplitText called
        // before fonts loaded"). Since this is the very first thing painted,
        // it's the most likely spot to hit that race — wait for the real
        // font so the logo split doesn't shift once it swaps in.
        ...
        <div className="size-full fixed z-51 overflow-hidden pointer-events-none">
            ...
            <div className="preloader-content">
                <div className="preloader-footer">
                    <p className="text-sm">
                        Software a medida y automatizaciones con n8n<br />
                        que hacen fluir tu negocio.
                    </p>
                </div>
            </div>
        </div >
