...
const Terminos = () => {
    ...
    return (
        <LegalLayout title="Términos y Condiciones" updatedAt="18/3/2024">
            ...
            <section>
                <h2 className="text-xl font-bold text-cream mb-2">1. Quiénes somos</h2>
                <p>
            ...
            <section>
                <h2 className="text-xl font-bold text-cream mb-2">2. Servicios ofrecidos</h2>
                <p>
            ...
            <section>
                <h2 className="text-xl font-bold text-cream mb-2">3. Uso del sitio</h2>
                <p>
            ...
            <section>
                <h2 className="text-xl font-bold text-cream mb-2">4. Apps para alquilar</h2>
                <p>
            ...
            <section>
                <h2 className="text-xl font-bold text-cream mb-2">5. Limitación de responsabilidad</h2>
                <p>
            ...
            <section>
                <h2 className="text-xl font-bold text-cream mb-2">6. Ley aplicable</h2>
                <p>
            ...
            <section>
                <h2 className="text-xl font-bold text-cream mb-2">7. Contacto</h2>
                <p>
                    ...
                    y el{" "}
                    <Link to="/aviso-legal" className="text-accent-primary underline">
                        Aviso Legal
                    </Link>.
                </p>
            </section>
