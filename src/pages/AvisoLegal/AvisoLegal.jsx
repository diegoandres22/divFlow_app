...
const AvisoLegal = () => {
    ...
    return (
        <LegalLayout title="Aviso Legal" updatedAt="18/3/2024">
            ...
            <section>
                <h2 className="text-xl font-bold text-cream mb-2">Identificación del responsable</h2>
                <ul className="flex flex-col gap-1">
                    <li><span className="text-tan">Titular / responsable: </span>Diego Andrés de Jesús Velásquez Moya</li>
                    <li><span className="text-tan">Nombre comercial: </span>DivFlow</li>
                    <li><span className="text-tan">Domicilio: </span>Caraballeda, La Guaira, Venezuela</li>
                    <li>
                        <span className="text-tan">Contacto: </span>
            ...
            <section>
                <h2 className="text-xl font-bold text-cream mb-2">Objeto del sitio</h2>
                <p>
            ...
            <section>
                <h2 className="text-xl font-bold text-cream mb-2">Propiedad intelectual</h2>
                <p>
            ...
            <section>
                <h2 className="text-xl font-bold text-cream mb-2">Enlaces relacionados</h2>
                <p>
                    Ver también la{" "}
                    <Link to="/privacidad" className="text-accent-primary underline">
                        Política de Privacidad
                    </Link>{" "}
                    y los{" "}
                    <Link to="/terminos" className="text-accent-primary underline">
